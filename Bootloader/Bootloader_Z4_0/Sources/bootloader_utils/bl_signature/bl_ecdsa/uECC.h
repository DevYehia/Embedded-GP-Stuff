...
#define uECC_PLATFORM 0       // Use generic C code (no platform-specific optimizations)
#define uECC_ENDIANNESS 1     // Big-endian (PowerPC uses big-endian)
#define uECC_NO_ASM           // Disable assembly code (no PowerPC assembly in Micro-ECC)
#define uECC_WORD_SIZE 4      // 32-bit word size (PowerPC is 32-bit)
